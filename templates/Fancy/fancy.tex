...
\fancyhf{}							
\cfoot{\color{darkgray} DocuCV R\'esum\'e -- Page \thepage{} of \totalpages}
...
%== HEADER ==%
\begin{center}
    {\fontsize{36}{36}\selectfont\interthin FANCY\interheavy DOCUCV} \\ \bigskip
    {\color{icnclr}\faEnvelope[regular]} \href{mailto:hi@example.com}{user@email.com} $|$ 
