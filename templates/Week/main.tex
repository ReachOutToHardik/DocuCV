...
\begin{center}
  {\Huge\bfseries\uppercase{DocuCV Resume}} \\ \medskip

  \href{mailto:youremail@example.com}{\faEnvelope\ user@email.com} \quad
  \href{https://www.linkedin.com}{\faLinkedin\ linkedin.com/in/username}
\end{center}
